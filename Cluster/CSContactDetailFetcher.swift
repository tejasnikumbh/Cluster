...
class CSContactDetailFetcher: NSObject {
    ...
    static func fetchContactDetailsWithCompletion(completion: ()->())-> CSContactDetailFetcher {
        ...
        let user2 = CSContactDetail(profilePicImageURL: "face", contactName: "Shaan Chugh", contactDesignation: "Quantitative Analyst", primaryPhone: "+91 888 342 2213", secondaryPhone: "+91 932 422 4352", primaryEmail: "schugh@stanford.edu", secondaryEmail: "schugh@gmail.com", address: "Cuff Parade, Bandra East, Mumbai, India")
        let userContactDetailsArray = [user1, user2]
        
        return CSContactDetailFetcher(userContactDetails: userContactDetailsArray)
    }

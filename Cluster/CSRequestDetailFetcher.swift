...
class CSRequestDetailFetcher: NSObject {
    ...
    class func fetchRequestDetailsWithCompletion(completion:(CSRequestDetailFetcher) -> Void) {
        ...
        let user3 = CSContactDetail(profilePicImageURL: "face3", contactName: "Neha Astana", contactDesignation: "Recruiter", primaryPhone: "+91 750 608 1238", secondaryPhone: "+91 997 073 5269", primaryEmail: "nehas@media.net", secondaryEmail: "tejasnikumbh@gmail.com", address: "221B, Baker Street, London , New England")
        let user4 = CSContactDetail(profilePicImageURL: "face4", contactName: "Jeff Bezos", contactDesignation: "Entrepreneur", primaryPhone: "+91 888 342 2213", secondaryPhone: "+91 932 422 4352", primaryEmail: "jeff@amazon.com", secondaryEmail: "schugh@gmail.com", address: "Cuff Parade, Bandra East, Mumbai, India")
        let user5 = CSContactDetail(profilePicImageURL: "face5", contactName: "Abhinav Chikara", contactDesignation: "Designer", primaryPhone: "+91 750 608 1238", secondaryPhone: "+91 997 073 5269", primaryEmail: "abhinav.chikara@gmail.com", secondaryEmail: "tejasnikumbh@gmail.com", address: "221B, Baker Street, London , New England")
